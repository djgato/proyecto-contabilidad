...
$deuda_por_pagar = $suma_haber - $suma_debe;
echo "Monto restante por pagar: ".$deuda_por_pagar."<br>";
echo 'Monto a Pagar: <input type"text" name="cant"><br>';
echo '<input type="submit" name="Enviar" value="Procesar">';
echo "<input name='cuenta' id='cuenta' type='hidden' value='$id_cuenta' />";
echo "<input name='operacion' id='operacion' type='hidden' value='pago' />";
?>